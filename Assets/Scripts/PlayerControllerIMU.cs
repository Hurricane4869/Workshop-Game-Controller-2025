...
public class PlayerControllerIMU : MonoBehaviour
{
    public static PlayerControllerIMU Instance { get; private set; }
    ...
    [SerializeField] private IMUReader imu;
    ...
    void Jump()
    {
        ...
        if ((pitch > 50f || pitch < -50f) && jumpCount > 0)
        {
            rb2.velocity = new Vector2(rb2.velocity.x, jumpForce);
            jumpCount--;
        }
